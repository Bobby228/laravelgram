...
<template>
    <div class="w-96 mx-auto">
        ...
        <div class="mb-4">
            <div class="mb-3">
                <input v-model="title" class="w-96 border p-2 rounded-3xl border-1 border-slate-400" type="text"
                       placeholder="title">
            ...
            <div class="flex mb-3 items-center">
                <div>
                    ...
                    <a href="#" class="block p-2 text-center w-16 text-sm rounded-3xl bg-sky-500 text-white"
        ...
        <div v-if="posts">
            <h1 class="mb-4 pb-8 border-b border-grey-400">Posts</h1>
